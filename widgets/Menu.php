...
class Menu extends Widget
{
     ...
     * <a id="nav-link--home" class="nav-link text-uppercase g-color-primary--hover g-px-5 g-py-20" href="/helmet">
    Helmets
    </a>
     */
    public $linkTemplate = '<a id="nav-link--home" class="nav-link text-uppercase g-color-primary--hover g-px-5 g-py-20"  href="{url}">{label}</a>';
    /**

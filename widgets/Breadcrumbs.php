...
class Breadcrumbs extends Widget
{
     ...
     */
    public $itemTemplate = "<li class='list-inline-item g-mr-5'>{link}<i class='g-color-gray-light-v2 g-ml-5 fa fa-angle-right'></i></li>\n";
    /**
     * @var string the template used to render each active item in the breadcrumbs. The token `{link}`
     * will be replaced with the actual HTML link for each active item.
     */
    public $activeItemTemplate = "<li class='list-inline-item g-color-primary'> <span>{link}</span></li>\n";
//    public $activeItemTemplate = "<li class='list-inline-item g-color-primary'> <span>{link}</span></li>\n";
    ...
    protected function renderItem($link, $template)
    {
        ...
        if (isset($link['url'])) {
            ...
            $options['class'] = 'u-link-v5 g-color-text';

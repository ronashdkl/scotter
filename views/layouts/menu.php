                                                ...
                                                <div class="g-pa-30">
                                                    ...
                                                    foreach ($category->getCategories()->where(['show_in_menu'=>Configuration::YES])->all() as $subCategory) {
                                                            ...
                                                            <a class="d-block g-color-text g-color-primary--hover g-text-underline--none--hover g-py-5"
                                                               href="/category/'.urlencode($product->category->title).'/product/'.urlencode($product->getName()).'/'.urlencode($product->sku).'">- '.$product->getName().'</a>
                                                        </li>';
                                                               }
                                                            ...
                                                            <article
                                                                ...
                                                                <div class="g-pos-rel g-z-index-1">
                                                                    ...
                                                                    <a class="btn u-btn-white g-brd-primary--hover g-color-white--hover g-bg-primary--hover g-font-size-11 text-uppercase g-py-10 g-px-20"
                                                                       href="/category/<?=urlencode($featureCatProduct->category->title).'/product/'.urlencode($featureCatProduct->getName()).'/'.urlencode($featureCatProduct->sku)?>">Shop Now</a>
                                                                </div>
                                                            </article>
                                                            <!-- End Article -->
                                                        </div>

...
class AttributeController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Attribute",
                    'content'=>'<span class="text-success">Create Attribute success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Attribute model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Attribute model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    {        
        ...
        foreach ( $pks as $pk ) {
            $model = $this->findModel(Encription::encryptIt($pk));
    ...
    {
        if (($model = Attribute::findOne(Encription::decryptIt($id))) !== null) {
            return $model;
        } else {

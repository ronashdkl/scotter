...
use app\models\search\CategoryContentSearch;
...
class CategoryContentController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model->category_id = intval(Encription::decryptIt($request->getQueryParam('id')));
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new CategoryContent",
                    'content'=>'<span class="text-success">New content created</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"])
       ...
       // $id = intval(Encription::decryptIt($id));
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update CategoryContent #".$id,
    ...
    /**
     * Delete an existing CategoryContent model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CategoryContent model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
